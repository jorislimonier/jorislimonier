    ...
    <td>
      <details>
        ...
        <p>I held a workshop for <a href="https://www.linkedin.com/in/jousefmurad/">Jousef Murad</a> (~90K followers)
          where I taught students about the basics of julia.
          <br>
          Most students had an engineering background and were familiar with Matlab, so I wanted to show them other
          available options out there. The workshop was a success and several students asked for more information in the
          days that followed.
        </p>
      </details>
    </td>
    ...
    <td>
      <details>
        ...
        <p>In order to broaden my horizons and get ready for upcoming opportunities, I decided to spend some time
          ...
          <br>
          I solved some Computer Science problems such as the ones in the
  ...
  <tr>
    ...
    <td>
      <details>
        ...
        <p>In order to broaden my horizons and get ready for upcoming opportunities, I decided to spend some time
          learning the basics of Scala. I also knew that PySpark is based on Spark, which is written in Scala so this is
          an opportunity to sharpen my Data Science/Data Engineering skills by getting to know the root language of
          PySpark.
          <br>
          I solved some Data Analysis problems.
        </p>
      </details>
    </td>
  </tr>
